...
---called when a creature is swallowed
...
function SP_RegurgitatePrey(pred, prey, preyState, spell)
	...
	if Osi.TemplateIsInInventory('eb1d0750-903e-44a9-927e-85200b9ecc5e', pred) == 1 and preyState ~= 1 and spell ~= "LevelChange" then
...
---@param pred GUIDSTRING guid of pred
---@param items boolean is there items in the pred?
